...
- **If QA fails**: Fix issues that are safe to fix silently (typos, missing type annotations). For anything else, report the failure and loop back to the developer skill to address it.
