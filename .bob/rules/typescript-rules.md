...
TypeScript's compile-time checks are erased at runtime. For data from external sources (APIs, user input), you _must_ perform runtime validation to prevent crashes.
